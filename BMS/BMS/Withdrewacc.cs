...
namespace BMS
{
    public partial class Withdrewacc : Form
    {
        public Withdrewacc()
        {
            InitializeComponent();
        ...
        private void withdrew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string cuswith = "select* from Customer where Customer_ID = '" + txtid.Text + "' and totalBalance >= '" + txtmoney.Text + "'";
                ...
                cmd.Parameters.AddWithValue("@withdrewmoney", txtmoney.Text);
        ...
        private void Withdrewacc_Load(object sender, EventArgs e)
        {
